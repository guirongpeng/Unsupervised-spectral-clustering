...
def _weighted_kmeans_gpu(
    ...
    """GPU equivalent; initialization and convergence rules remain unchanged."""
    ...
    for iteration in range(max_iter):
        ...
        cost = _weighted_kmeans_cost_gpu(
            values, labels, centers_gpu, weights, beta, cp
        )
...
def _assign_weighted_clusters_gpu(
    X: object, centers: object, weights: object, chunk_size: int, cp: object
) -> object:
